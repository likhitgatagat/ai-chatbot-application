...
// Airtable base name used in this example is "Likhit Gatagat Embeddings" and Airtable view is "Grid view".
...
app.post("/ask", async (req, res) => {
  ...
  try {
    ...
    if (Object.keys(similarityScoreHash).length == 0)
    {
      return res.status(200).json({
        success: true,
        message: 'Requested information not found in Knowlegde Base... Try creating a knowledge base for the requested information.'
      });
